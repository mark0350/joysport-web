...
Tags: club, teams, sports, sports club, club management, club website, league tables, team rosters, fixtures, results 
...
WP Club Manager is easy to set-up and has everything you need to build and manage a pro website for a sports club or team, for free.
...
Davey Jacobson, *Digital Media Administrator*, [USA Rugby](http://usarugby.org)
...
* Fix - Fixed missing values in status report
* Localisation - Updated German and Danish languages (Thanks King3R and morbri63)
...
= 1.4.0 =
1.4 is a major update so it is important that you make backups, and ensure themes and extensions are 1.4 compatible before upgrading. See [release notes](http://wpclubmanager.com/wp-club-manager-1-4-released) for more details.

Note: 1.4 includes improvements to most templates. If your theme uses custom templates then please ensure your theme supports 1.4 **before** updating.